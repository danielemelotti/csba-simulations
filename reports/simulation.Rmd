...
$$
h = \frac{3.49\cdot\hat\sigma}{\sqrt[3]n}
$$
...
Finally, Freedman-Diaconis' choice:
$$
h = 2\cdot\frac{IQR(x)}{\sqrt[3]n}
$$
...
knitr::kable(hk_summary,
             caption = "Table 1: Summary of bin width and number of bins")
...
Now, let's verify which method is more or less sensitive to outliers in the data. We focus especially on changes in terms of bin width. We extend _rand_data_ with some outliers and recompute all the bin widths and number of bins with the three methods:
```{r}
...
# Summary
knitr::kable(hk_out_summary,
             caption = "Table 1: Summary of bin width and number of bins - Outlier Data")
```
